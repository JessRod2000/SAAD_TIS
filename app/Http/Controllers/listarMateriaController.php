...
{
    public function docentesDeReserva($idReserva){
    ...
    public function listarTodo(){
        $reservas = \DB::table('solicitud_reserva')
         ...
         ->select('Id_SR','Nombre_M','Fecha_SR','Hora_Inicio_SR','Estado_Atendido_SR')
         ->get();
    ...
    public function listarPendientes(){
        $reservas = \DB::table('solicitud_reserva')
         ...
         ->join('users','Codigo_SIS_U','=','usuarios_Codigo_SIS_U')
         ->join('materia','materia_Codigo_M','=','Codigo_M')
         ->select('Id_SR','Nombre_M','Fecha_SR','Hora_Inicio_SR')
         ->where('Fecha_SR','>',now())
